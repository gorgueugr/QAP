...
all:	folders
	...
	g++ -o bin/qap  obj/grasp.o  obj/memetic.o obj/genetic.o obj/problem.o  obj/ils.o  obj/es.o obj/input.o obj/localsearch.o obj/bmb.o obj/greedy.o  obj/random.o obj/main.o -fopenmp
folders:
	mkdir -p bin obj
